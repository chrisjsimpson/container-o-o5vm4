...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o-o5vm4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o-o5vm4.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-o-o5vm4.git
cd container-o-o5vm4
```
...
```
docker attach container-o-o5vm4
```
